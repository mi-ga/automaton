...
public class ProjectInsertPage extends TWizardPage implements InsertListener, ClipboardOwner {
    ...
    public void projectInsertFinished(Project project, boolean success, Throwable cause) {
        ...
        if (success) {
            ...
            I18n.getMessage("jsite.insert.inserted"), I18n.getMessage("jsite.insert.done.title"),
            0, JOptionPane.INFORMATION_MESSAGE, null, new Object[]{I18n.getMessage("jsite.general.ok"),
            copyURILabel}, copyURILabel);
             */
