...
public class ProjectPage extends TWizardPage implements ListSelectionListener, DocumentListener, ClipboardOwner {
   ...
   System.out.print("XXXTWizard wizard");
    ...
    private JComponent createInformationPanel() {
        ...
        addButton = new JButton(projectAddAction);
    ...
    private void actionAdd() {
        ...
        try {
            ...
            return;
                 ...
                 newProject.setName(automate.inf.getF_Name());
                 ...
                 newProject.setLocalPath(automate.inf.getLocalPath());
                newProject.setPath(automate.inf.getF_Name());
                newProject.setDescription(automate.inf.getF_Name()+"_desc");
...
System.out.println("-->"+projectListModel.indexOf(newProject));
